      ...
      <div className="container-custom">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-800 max-w-3xl mx-auto">
            O Curso S.O.S Terapias Integrativas Complementares é o seu guia prático para transformar a paixão por ajudar em uma carreira de impacto. Aprenda a técnica Seitai prática complementar para aliviar dores e promover bem-estar.
          </p>
        </div>
